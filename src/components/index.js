...
export { default as ProductDetails } from './ProductView/ProductDetails';
export { default as ProductView } from './ProductView/ProductView';
export { default as ViewImages } from './ProductView/ViewImages';
export { default as ViewInfo } from './ProductView/ViewInfo';
